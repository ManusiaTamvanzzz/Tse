...
exports.allmenu = (conn, sender, prefix, pushname, isOwner, isCreator, isPremium, balance, limit, limitCount, glimit, gcount) => {
	return `*${botName}* ᴀᴅᴀʟᴀʜ ᴘʀᴏɢʀᴀᴍ ʙᴏᴛ ᴡʜᴀᴛꜱᴀᴘᴘ ʏᴀɴɢ ꜱɪᴀᴘ ᴍᴇᴍʙᴀɴᴛᴜ ᴀɴᴅᴀ ᴅᴀʟᴀᴍ ᴍᴇʟᴀᴋᴜᴋᴀɴ ʙᴇʀʙᴀɢᴀɪ ᴛɪɴᴅᴀᴋᴀɴ, ᴍᴇɴᴄᴀʀɪ ᴅᴀᴛᴀ ᴀᴛᴀᴜ ɪɴꜰᴏʀᴍᴀꜱɪ ᴍᴇʟᴀʟᴜɪ ᴡʜᴀᴛꜱᴀᴘᴘ.
...
LIST MENU
• _*${prefix}menu main*_
• _*${prefix}menu conver*_
• _*${prefix}menu tools*_
• _*${prefix}menu stiker*_
• _*${prefix}menu anonymous*_
• _*${prefix}menu ai*_
• _*${prefix}menu download*_
• _*${prefix}menu religion*_
• _*${prefix}menu photooxy*_
• _*${prefix}menu random*_
• _*${prefix}menu search*_
• _*${prefix}menu game*_
• _*${prefix}menu payment*_
• _*${prefix}menu group*_
• _*${prefix}menu bug*_
• _*${prefix}menu owner*_
